  ...
  <div class="container-form">
      <div class="background-input">
          <div class="right-input">
              ...
              <input type="text" placeholder="Nome da empresa" onChange={(e)=>setNomeEmpresa(e.target.value)}/>
              </div>
             
              <div class="input-type">
              <label>CPF</label>
              <input type="number" placeholder="CPF" onChange={(e)=>setCpf(e.target.value)}/>
              </div>
              <div class="input-type">
              <label>Telefone</label>
              <input type="text" placeholder="Seu Nome" onChange={(e)=>setRepresentanteEmpresa(e.target.value)}/>
              </div>
              <div class="input-type">
              <label>Email</label>
          ...
          <button class="input-send" id="enviar_register" onClick={handleSubmit}><Link to ='/anuncie'>Enviar</Link></button>
